  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        // تم استبدال ImageFilter.blur الثقيل بتدرجات شعاعية
        // أخف بكثير على GPU مع الحفاظ على نفس الإحساس البصري.
        const Positioned(
          top: -100,
          right: -80,
          child: _SoftCircle(
            size: 260,
            color: Color(0x2118A99A),
          ),
        ),
...
class _LoginCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        // خلفية شبه شفافة بدون BackdropFilter.
        // هذا يحافظ على الإحساس الزجاجي مع تكلفة رسم أقل بكثير.
