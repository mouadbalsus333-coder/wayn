...
class _WalletPageState extends State<WalletPage> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFF18A99A), Color(0xFF087F78)],
        ),
  ...
  Widget _money(String title, int amount, IconData icon) {
    return Padding(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  transaction.createdAt.toLocal().toString().substring(0, 16),
                  style: const TextStyle(
                    fontSize: 11,
  ...
  String _type(String value) => value.replaceAll('_', ' ').toLowerCase();
  ...
  Widget _empty() {
    return const Padding(
      ...
      child: Center(
        child: Text(
          'لا توجد عمليات بعد',
          style: TextStyle(color: Color(0xFF8B94A3)),
        ),
      ),
    );
  }
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButton<WalletAsset>(
                        value: asset,
                        isExpanded: true,
                        items: const [
                          DropdownMenuItem(
                            value: WalletAsset.coins,
                            child: Text('عملات'),
                          ),
                          DropdownMenuItem(
                            value: WalletAsset.points,
                            child: Text('نقاط'),
                          ),
                        ],
                        onChanged: (value) {
                          if (value != null) {
                            setDialogState(() => asset = value);
                          }
                        },
                      ),
                    ],
                  ...
                  onPressed: () async {
                    try {
                      ...
                      await _service.transfer(
                        receiverWalletNumber: numberController.text.trim(),
                        asset: asset,
                        amount: amount,
